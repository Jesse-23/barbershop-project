    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white selection:bg-[#dfb771] selection:text-black">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#0a0a0a]/80 backdrop-blur-md border-b border-white/5">
        <nav className="flex justify-between items-center px-8 py-6 max-w-7xl mx-auto w-full">
          <div className="flex items-center gap-2 text-[#dfb771]">
            <Scissors size={24} />
      ...
      <section className="relative min-h-screen flex flex-col pt-28">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div 
            className="absolute inset-0 bg-[url('/hero-image/hero-barber-bg.jpg')] bg-cover bg-center bg-no-repeat opacity-60"
          />
        </div>
      ...
      <section className="py-24 px-8 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <span className="text-[#dfb771] text-xs tracking-[0.2em] font-bold uppercase mb-4 block">Why Us</span>
      ...
      <section className="py-24 px-8 max-w-7xl mx-auto border-t border-white/5">
        <div className="text-center mb-16">
          <span className="text-[#dfb771] text-xs tracking-[0.2em] font-bold uppercase mb-4 block">Word on the street</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-[#111111] border border-white/5 p-8 rounded-xl flex flex-col justify-between">
            ...
            <div>
              <p className="font-medium text-sm">Marcus T.</p>
      ...
      <footer className="border-t border-white/10 pt-16 pb-8 px-8 max-w-7xl mx-auto text-sm">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          <div>
            <div className="flex items-center gap-2 text-[#dfb771] mb-6">
              <Scissors size={20} />
