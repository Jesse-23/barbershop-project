...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-b^lhflbpc3m5e#ucis#bdia18*ueerztcjy6lo&+ly6^v2f_*&')
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgres://postgres:jesse78@localhost:5432/cutcraft_db',
        conn_max_age=600
    )
}
...
# Allow all origins if deploying frontend to Vercel dynamically or add your specific Vercel URL here
